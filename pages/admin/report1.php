<?php if (isset($_SESSION['staff-user']) && $_SESSION['staff-user'] !== '') { ?>
    <?php if ($level == 'supervisor') { ?>
        <h1 class='text-center hide'>หน้า | รายงานคนใช้บริการ</h1>
        <div class="row">
            <div class="col-lg-12">
                <h3 class="alert alert-success" class="page-header alert btn-info"><i class="fa fa-table"></i> รายงานคนใช้บริการ</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="row">
    ...
    $(document).ready(function() {
      ...
      $('#dataTables-example').dataTable({
        responsive: true,"order": [[ 1, "DESC" ]],		  
                            ...
                            <a href="../pages/report12.php" class="btn btn-primary btn-xs  "> <i class="fa fa-print icon"></i> ดาวโหลด</a>
                            <br><br>
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <div>
                                        <input class="form-control mr-sm-1" id="myInput" type="text" placeholder="ค้นหาข้อมูล ลำดับ, ชื่อ, ประเภท"><br>
                                    </div>
