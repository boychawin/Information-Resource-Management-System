...
$query = "CREATE TABLE IF NOT EXISTS booking(id INT NOT NULL AUTO_INCREMENT
    PRIMARY KEY, booking_id BIGINT NOT NULL UNIQUE, booking_type ENUM('1',
...
$stmt = "CREATE TABLE IF NOT EXISTS booking_applications(id INT NOT NULL AUTO_INCREMENT
    PRIMARY KEY, booking_id BIGINT NOT NULL, staff_id BIGINT NOT NULL,
    booking_type VARCHAR(250) NOT NULL,booking_start_date VARCHAR(25) NOT NULL,
    booking_end_date VARCHAR(25) NOT NULL, action ENUM('accept','reject'),
...
$res = "CREATE TABLE IF NOT EXISTS user_booking_metadata(id INT NOT NULL AUTO_INCREMENT
    PRIMARY KEY, booking_id BIGINT NOT NULL UNIQUE, staff_id BIGINT NOT NULL,
    booking_type VARCHAR(250) NOT NULL,total_yr_booking_count BIGINT NOT NULL,
    total_month_booking_count BIGINT NOT NULL, yr_booking_left BIGINT NOT NULL,
    month_booking_left BIGINT NOT NULL, total_booking_left_staff BIGINT NOT NULL)";

$results[] = $db_con->query($res);

$querry = "CREATE TABLE IF NOT EXISTS accepted_booking(id INT NOT NULL AUTO_INCREMENT
    PRIMARY KEY, booking_id BIGINT NOT NULL, staff_id BIGINT NOT NULL,
    booking_type VARCHAR(250) NOT NULL, num_days INT NOT NULL,
...
$qry = "CREATE TABLE IF NOT EXISTS rejected_booking(id INT NOT NULL AUTO_INCREMENT
    PRIMARY KEY, booking_id BIGINT NOT NULL, staff_id BIGINT NOT NULL,
...
$sqlquery = "CREATE TABLE IF NOT EXISTS recommended_booking(id INT NOT
    NULL AUTO_INCREMENT PRIMARY KEY, booking_id BIGINT NOT NULL,
    booking_type VARCHAR(250) NOT NULL,staff_id BIGINT NOT NULL,num_days INT NOT NULL,
...
$sql_query = "CREATE TABLE IF NOT EXISTS job_description(id INT NOT NULL
    ...
    annual_booking_days_allowed INT NOT NULL, total_booking_days INT NOT NULL,
    total_taken_bookings INT NOT NULL)";
