...
<nav class="fixed-top navbar-expand-lg navbar-expand-xl navbar ">
    <a href="../pages/index" rel="home">
        <img src="../images/irms-arit.png" width="276" height="50" class="img-fluid" href="/irms"
...
';
            ...
            <li class='nav-item dropdown'>
                <a class='nav-link dropdown-toggle' href='#' id='navbarDropdownMenuLink' data-toggle='dropdown'
                    aria-haspopup='true' aria-expanded='false' title='' '' href='/irms/pages/dashboard.php?tab=4'>
                    <i class='fa fa-table'></i> สถานะห้อง/โต๊ะ</a>
                <div class='dropdown-menu' aria-labelledby='navbarDropdownMenuLink'>
             ...
             <img src="' .
                ...
                '' href='/irms/pages/dashboard.php?tab=4'>
                    ...
                    <div class='dropdown-menu' aria-labelledby='navbarDropdownMenuLink'>
                        ...
                        <a class='dropdown-item' href='index?tab=4'>
                            <i class='fa fa-calendar '></i>
                            <span class='extra-sm'>แบบปฏิทิน</span>
                        </a>
                        <a class='dropdown-item' href='index?tab=3'>
                            <i class='fa fa-table '></i>
                            <span class='extra-sm '>แบบตาราง</span>
                        </a>
                ...
                <li class='nav-item'>
                    <a class='nav-link' href='index?tab=7'>
                        <i class='fa fa-bullhorn'></i>
                        <span class='extra-sm'>รายการแจ้งลืมของ</span>
                    </a>
                </li>
                ...
                <li class='nav-item'>
                    <a class='nav-link' href='index?tab=5'>
                        <i class='fa fa-map-marker'></i>
                        <span class='extra-sm'>ข้อมูลห้อง/โต๊ะ</span>
                    </a>
                </li>
                ...
                <li class='nav-item'>
                    <a class='nav-link'href='index?tab=6'>
                        <i class='fa fa-key'></i>
                        <span class='extra-sm'>กฎกติกา</span>
                    </a>
                </li>
                ...
                <li class='nav-item'>
                    <a class='nav-link'href='index?tab=2'>
                ...
                <li class='nav-item'>
                <a class='nav-link'href='index?tab=8'>
                    <i class='fa fa-sign-out'></i>
...
<div class="loader">
    <img src="../images/VAyR.gif" alt="Loading..." />
</div>
<br>
<!-- <div class="row"> -->