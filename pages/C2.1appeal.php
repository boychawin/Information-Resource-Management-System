    ...
    <div class="col-sm-4">
        <div class="table-responsive">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link " href="index.php?tab=7">ยังไม่มารับ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="index.php?tab=7.1">รับของแล้ว</a>
                </li>
...
$resulta = $db_con->query(
  "SELECT * FROM tblmessage WHERE Mstatus = 'รับของแล้ว'"
);
    ...
    <div class="col-sm-4">
        <div class="card ">
            <div class="bg-white text-dark">
                <a target="_blank" href="../pages/user/myfile/<?php echo $rs['Mimage']; ?>"> <img id="myImg"
                        src="../pages/user/myfile/<?php echo $rs['Mimage']; ?>" alt="Snow"
                ...
                <div class="panel-body">
                    ...
                    <p><b>วันที่รับ : </b><?php echo thai11($rs['date_receive']); ?></p>
                    <br>
                    <?php echo $status; ?>
