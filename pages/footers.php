    ...
    <div class="row">
            ...
            <ul class="footer-list text-center">
                <li>
                    <h5 class="text-center">
                        <font class="extra-sm"> ติดต่อสอบถาม</font>
                    </h5>
                </li>
                <li>
                    <b>
        ...
        <div class="col-sm-4 mt-20">
            <ul class="footer-list text-center">
                <li>
                    <h5 class="text-center">
                        <font class="extra-sm"> เวลาเปิดให้บริการ</font>
                    </h5>
                </li>
                <li>
                    <b>
                ...
                <li>
                    <font class="extra-sm">วันจันทร์ - วันศุกร์ เวลา 08.00 น. - 16.30 น.</font>
                </li>
                <li>
        ...
        <div class="col-sm-4 mt-20">
            <ul class="footer-list text-center">
                ...
                <li>
                    <h5 class="text-center">
                        <font class="extra-sm"> ติดตามเราได้ที่</font>
                    </h5>
                </li>
                <li>
...
<a href="https://boychawin.com/" type='hidden'></a>
<script>
function chspace() {
    if (event.keyCode == 32)
        return false;
