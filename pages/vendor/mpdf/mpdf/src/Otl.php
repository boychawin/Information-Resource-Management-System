...
class Otl
{
	...
	function applyOTL($str, $useOTL)
	{
		...
		// This bookings OTLdata::GPOSinfo, ::bidi_type, & ::group
	...
	function GSUBsubstitute($pos, $substitute, $Type, $GlyphPos = null)
	{
		...
		elseif ($Type == 4) {
			...
			if ($contains_marks && !$contains_nonmarks) {
				...
				/*
				 * - If it *is* a mark ligature, we don't allocate a new ligature id, and booking
				 *   the ligature to keep its old ligature id.  This will allow it to attach to
				 *   a base ligature in GPOS.  Eg. if the sequence is: LAM,LAM,SHADDA,FATHA,HEH,
				 *   and LAM,LAM,HEH form a ligature, they will booking SHADDA and FATHA wit a
